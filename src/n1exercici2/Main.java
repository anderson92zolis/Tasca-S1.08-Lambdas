...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * una llista amb els Strings que a més de contenir la lletra ‘o’ també tenen més de
		 * 5 lletres. Imprimeix el resultat.
		 */
	
		
	ArrayList<String> llistaString = new ArrayList<String>(Arrays.asList("Volvo","BMW","Ford","Mazda","BMWoooooo"));

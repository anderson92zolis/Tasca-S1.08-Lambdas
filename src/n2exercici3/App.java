...
public class App {
	...
	public static void main(String[] args) {
		...
		/*
		 * - Exercici 3 Crea una Functional Interface que contingui un mètode anomenat
		 * operacio(). Aquest mètode ha de retornar un float. Injecta a la interfície
		 * creada mitjançant una lambda, el cos del mètode, de manera que es pugui
		 * transformar l’operació amb una suma, una resta, una multiplicació i una
		 * divisió.
		 */
